...
import { Button as DiffButton, Comparison, type DiffData } from '@/components/diff-viewer'
...
export default function DiffPage() {
  ...
  const [symbol1, setSymbol1] = useState(searchParams.get('symbol1') || 'A/RES/60/152')
  const [symbol2, setSymbol2] = useState(searchParams.get('symbol2') || 'A/RES/61/156')
  const [diffData, setDiffData] = useState<DiffData | null>(null)
  const [loading, setLoading] = useState(false)
  const [error, setError] = useState<string | null>(null)
  const [focus, setFocus] = useState<string | null>(null)
  const [documentTitles, setDocumentTitles] = useState<{[symbol: string]: string}>({})
  ...
  const hasQueryParams = searchParams.get('symbol1') || searchParams.get('symbol2')
  ...
  const exampleComparisons = [
    ...
    { symbol1: 'A/RES/77/187', year1: '2022', symbol2: 'A/RES/78/170', year2: '2023' },
    { symbol1: 'A/RES/57/217', year1: '2002', symbol2: 'A/RES/58/188', year2: '2003' },
  ]
          ...
          <div className="space-y-6">
            ...
            <div className="bg-muted/30 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Document Symbol 1</label>
                  <input
                    type="text"
                    value={symbol1}
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Document Symbol 2</label>
                  <input
                    type="text"
                    value={symbol2}
            ...
            <div className="bg-white rounded-lg border p-6">
              <h2 className="text-lg font-semibold mb-4">Example Comparisons</h2>
