    ...
    <div>
      ...
      <div className="max-w-[780px] text-left">
        ...
        <Button
          variant="outline"
          size="sm"
          className="mt-6 mb-20 shrink-0 inline-flex items-center gap-1 sm:gap-2 text-xs sm:text-sm px-2 py-1 sm:px-2.5 sm:py-1.5 h-auto bg-trout! text-white! hover:bg-trout/90! transition-colors"
