...
The resolutions page displays UN resolutions in two views: **Treemap** (default) and **Table**.
It uses a shared infrastructure for filtering, data fetching, and visualization.
