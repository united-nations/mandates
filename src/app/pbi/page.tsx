                    ...
                    <tr>
                      <td colSpan={5} className="px-4 py-4 bg-gray-50">
                        <div className="space-y-3">
                          ...
                          {(() => {
                            const budgetSection = sortedStages.find(
                              (s) => s.budget_section,
                            )?.budget_section;
                                ...
                                {sortedStages.map((stage, idx) => {
                                  ...
                                  const getStageLabel = (
                                    ...
                                    if (committee === "Plenary") {
                                      if (
                                        docType === "fifth_committee_decision"
                                      ) {
                                        return short
                                          ? "C.5→GA"
                                          : "Fifth Committee Report to GA";
                                      }
                                      return short
                                        ? "C.5→GA"
                                        : "Fifth Committee Report to GA";
                                    ...
                                    if (committee === "ACABQ") {
                                      return short
                                        ? "ACABQ"
                                        : "ACABQ Advisory Report";
                                    }
                                    if (committee === "5") {
                                      return short
                                        ? "SG→C.5"
                                        : "SG Statement to Fifth Committee";
                                    }
