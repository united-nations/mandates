        ...
        <main className="w-full max-w-4xl lg:max-w-6xl xl:max-w-7xl mx-auto py-6 space-y-6 px-8 sm:px-12 lg:px-16">
              ...
              <div className="flex-1">
                ...
                <div className="text-muted-foreground mt-2 sm:text-justify">
                  <p className="leading-tight mb-3">
                    Exploring mandates and cross-citations for <strong>{entityLongName || entityName}</strong>. This view shows all documents that cite this entity, 
                    along with other entities that share cited mandates.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section>
            <MandateExplorer 
              ...
              mandateListTitle={`Documents Citing ${entityLongName || entityName}`}
            />
          </section>
        </main>
      </div>
