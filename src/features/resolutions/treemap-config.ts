...
export const lengthBuckets: BucketDefinition[] = [
  ...
  },
  {
    ...
    min: 2001,
    max: 5000,
    description: '2,000 to 5,000 words',
  },
  {
    id: '1k-2k',
    label: '1K⎼2K',
    min: 1001,
    max: 2000,
    description: '1,000 to 2,000 words',
  },
  {
    id: '0.5k-1k',
    label: '0.5K⎼1K',
  ...
  },
  {
    ...
    min: null,
    max: null,
    description: 'No word count data',
  },
]
...
export const similarityBuckets: BucketDefinition[] = [
  ...
  { id: '<30', label: '<30%', min: 0, max: 0.3, description: 'Very different' },
  {
    id: 'new',
    label: 'New/First',
    min: null,
...
export const frequencyBuckets: BucketDefinition[] = [
  ...
  },
  {
    ...
    min: 6,
    max: null,
    description: 'More than 5 years ago',
  },
  {
    id: 'one-time',
    label: 'One-time',
